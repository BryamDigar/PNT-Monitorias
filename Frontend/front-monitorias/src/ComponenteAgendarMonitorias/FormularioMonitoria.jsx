import "./Styles/FormularioMonitoria.css"
                ...
                <div className="container">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="form-group">
                            ...
                            <select name="materia" id="materia" value={materia} className="form-select" aria-label="Default select example" form-select-border-width="10px"  onChange={(event) =>  setMateria(event.target.value)}>
                                <option value=""></option>
